...
- scatterplot
  ...
  #+BEGIN_SRC R :results output graphics :file ../../images/cars.png :width 400 :height 300 :exports both
    library('openintro')
    library('ggplot2')
...
- dot plot
  ...
  #+BEGIN_SRC R :results output graphics :file ../../images/email50.png :width 400 :height 300 :exports both
    library('openintro')
    library('ggplot2')
  ...
  #+RESULTS:
  [[file:../../images/email50.png]]

  
- histogram
  
  #+BEGIN_SRC R :results output graphics :file ../../images/histogram.png :width 400 :height 300
    library('openintro')
    library('ggplot2')
